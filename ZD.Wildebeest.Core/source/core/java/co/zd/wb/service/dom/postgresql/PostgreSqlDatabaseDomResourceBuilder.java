...
/**
 * A {@link ResourceBuilder} that builds a {@link PostgreSqlDatabaseResource} from a DOM {@link org.w3c.dom.Element}.
 * 
 * @author                                      Brendon Matheson
 * @since                                       1.0
 */
public class PostgreSqlDatabaseDomResourceBuilder extends BaseDomResourceBuilder
{
	@Override public Resource build(
		UUID id,
		String name) throws MessagesException
	{
		return new PostgreSqlDatabaseResource(id, name);
	}
}
