...
public interface Migration
{
	...
	/**
	 * Gets the optional source State for this Migration.  A Migration without a source State migrates from the
	 * non-existent state (i.e. creates the resource instance from nothing).
	 *
