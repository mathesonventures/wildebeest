...
/**
 * Handler for {@link DatabaseDoesNotExistAssertion}.
 *
 * @since 4.0
 */
@PluginHandler(
...
public class DatabaseDoesNotExistAssertionPlugin implements AssertionPlugin
{
		...
		Instance instance)
	{
		...
		DatabaseDoesNotExistAssertion assertionT = (DatabaseDoesNotExistAssertion)assertion;
