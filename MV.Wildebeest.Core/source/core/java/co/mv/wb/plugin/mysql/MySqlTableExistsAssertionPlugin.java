...
/**
 * Handler for {@link MySqlTableExistsAssertion}.
 *
 * @since 4.0
 */
@PluginHandler(
...
public class MySqlTableExistsAssertionPlugin implements AssertionPlugin
{
		...
		Instance instance)
	{
		...
		MySqlTableExistsAssertion assertionT = (MySqlTableExistsAssertion)assertion;
