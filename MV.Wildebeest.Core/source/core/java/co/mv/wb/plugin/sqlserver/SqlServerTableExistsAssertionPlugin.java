...
/**
 * Handler for {@link SqlServerTableExistsAssertion}.
 *
 * @since 4.0
 */
@PluginHandler(
...
public class SqlServerTableExistsAssertionPlugin implements AssertionPlugin
{
		...
		Instance instance)
	{
		...
		SqlServerTableExistsAssertion assertionT = (SqlServerTableExistsAssertion)assertion;
		...
		{
			result = new ImmutableAssertionResponse(true, "Table " + assertionT.getTableName() + " exists");
		}

		else
		{
			result = new ImmutableAssertionResponse(false, "Table " + assertionT.getTableName() + " does not exist");
		}
