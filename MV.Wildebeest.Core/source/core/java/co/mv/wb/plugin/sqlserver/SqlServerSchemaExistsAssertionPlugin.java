...
/**
 * Handler for {@link SqlServerSchemaExistsAssertion}.
 *
 * @since 4.0
 */
public class SqlServerSchemaExistsAssertionPlugin implements AssertionPlugin
{
		...
		Instance instance)
	{
		...
		SqlServerSchemaExistsAssertion assertionT = (SqlServerSchemaExistsAssertion)assertion;
		...
		{
			result = new ImmutableAssertionResponse(true, "Schema " + assertionT.getSchemaName() + " exists");
		}

		else
		{
			result = new ImmutableAssertionResponse(false, "Schema " + assertionT.getSchemaName() + " does not exist");
		}
