...
/**
 * Handler for {@link AnsiSqlTableExistsAssertion}.
 *
 * @since 4.0
 */
public class AnsiSqlTableExistsAssertionPlugin implements AssertionPlugin
{
		...
		Instance instance)
	{
		...
		AnsiSqlTableExistsAssertion assertionT = (AnsiSqlTableExistsAssertion)assertion;
